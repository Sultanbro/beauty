...
var target;if(searchBtn.addEventListener("click",function(e){searchWrapper.classList.add("active")}),instagramLoad&&instagramLoad.addEventListener("click",function(e){instagramLoadCount+=1,document.querySelector(".instagram-photos-"+instagramLoadCount).classList.remove("invisible"),2==instagramLoadCount&&e.target.classList.add("invisible")}),shareIcon&&shareContainer&&(shareIcon.addEventListener("click",function(e){const t=this.querySelector(".share-container");t.classList.toggle("active"),e.stopPropagation()}),shareContainer.addEventListener("click",function(e){e.stopPropagation()}),document.body.addEventListener("click",function(e){const t=document.querySelectorAll(".share-container");for(var a=0;a<t.length;a++)t[a].classList.remove("active")})),closeSearch.addEventListener("click",function(e){searchWrapper.classList.remove("active")}),document.onkeydown=function(e){("key"in(e=e||window.event)?"Escape"===e.key||"Esc"===e.key:27===e.keyCode)&&searchWrapper.classList.remove("active")},toggleMenu(),null!==coverCarouselVar&&coverCarousel(),null!==detectAboutPage&&(testimonialCarousel(),toggleAccordion(),benefitCarousel()),null!==galleryCarouselVar&&galleryCarousel(),null!==brandsCarouselVar&&brandsCarousel(),null!==partnerCarouselVar&&partnerCarousel(),null!==blogVideo&&playVideo.addEventListener("click",function(e){blogVideo.classList.add("video-active")}),null!==richText&&(target=document.querySelectorAll("div, p, img, strong, blockquote, b, span"),Array.prototype.forEach.call(target,function(e){e.removeAttribute("style")})),null!==document.getElementById("brands-filter")){for(let e=0;e<brandFilter.length;e++)brandFilter[e].addEventListener("click",function(e){e.preventDefault();var t=window.location.href,a=e.target.getAttribute("key"),e=new URL(t).searchParams.get("filter");e&&0<e.length?(e=e.split(",")).includes(a)?-1<(t=e.indexOf(a))&&e.splice(t,1):e.push(a):(e=[]).push(a);e=e.map(function(e,t){return e}).join(",");window.location="?filter="+e});function setBrandFilterActive(){var e=window.location.href,t=new URL(e).searchParams.getAll("filter");if(t&&null!=t[0])for(var t=t[0].split(","),a=0;a<t.length;a++){var n=t[a];document.querySelector("#brands-filter a[key="+n+"]").classList.add("active")}else document.querySelector("#brands-filter a[key=all]").classList.add("active")}setBrandFilterActive()}null!==priceBtn&&priceBtn.addEventListener("click",function(e){body.classList.add("modal-opened"),priceModal.classList.add("active")});
function toggleAccordion(){let o=document.getElementsByClassName("accordion-item"),e=document.getElementsByClassName("accordion-title");for(i=0;i<e.length;i++)e[i].addEventListener("click",t,!1);function t(){var e=this.parentNode.className;for(i=0;i<o.length;i++)o[i].className="accordion-item close";"accordion-item close"==e&&(this.parentNode.className="accordion-item open")}}
$(".requestPrice").on("submit",function(t){t.preventDefault();var e=this,s=new FormData(e),t=$(this).attr("action");$(this).find(":input[type=submit]").prop("disabled",!0),$.ajax({url:t,data:s,cache:!1,processData:!1,contentType:!1,method:"POST"}).done(function(t){$(".form-message").css("display","block"),setTimeout(()=>{$(".form-message").css("display","none"),e.reset()},3500)}).fail(function(t,e,s){}).always(function(t,e,s){}),$(this).find(":input[type=submit]").prop("disabled",!1)});
function modalToggles(){}
function setCookie(e,t){let o=new Date;o.setTime(o.getTime()+31536e6);var n="expires="+o.toGMTString();document.cookie=e+"="+t+";"+n+";path=/"}function getCookie(e){var o=e+"=";let t=decodeURIComponent(document.cookie);var n=t.split(";");for(let t=0;t<n.length;t++){let e=n[t];for(;" "==e.charAt(0);)e=e.substring(1);if(0==e.indexOf(o))return e.substring(o.length,e.length)}return""}function checkCookie(){""==getCookie("username")&&767<window.innerWidth&&(newsLetterModal.classList.add("active"),body.classList.add("modal-opened"))}null!==newsLetterModal&&checkCookie(),closeModal.addEventListener("click",function(e){body.classList.remove("modal-opened"),null!==newsLetterModal&&newsLetterModal.classList.remove("active"),null!==priceBtn&&priceModal.classList.remove("active"),null!==document.querySelector("#not-show:checked")&&setCookie("username",1)});