...
@section('head')
    ...
    <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=60d2f5f96504e90013d7ddc6&product=inline-share-buttons" async="async"></script>
@stop
        ...
        <section class="collections">
            <div class="container">
                <div class="collection row">
                    ...
                    <div class="column">
                        <div class="collection__image">
                            <img src="{{ asset('am-beauty/img/blog-1.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="collection row">
                    <div class="column">
                        <div class="collection__image">
                            <img src="{{ asset('am-beauty/img/blog-2.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="column">
                        <div class="collection__information">
                ...
                <div class="collection row">
                    ...
                    <div class="column">
                        <div class="collection__image">
                            <img src="{{ asset('am-beauty/img/blog3.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="slide-content column">
                        ...
                        <div class="swiper-button-next">
                            <svg width="11" height="18" viewBox="0 0 11 18"  xmlns="http://www.w3.org/2000/svg">
                                <rect width="1.13112" height="12.7853" transform="matrix(0.756759 -0.653694 0.756759 0.653694 0.0932617 1.40601)" />
                                <rect width="1.13112" height="12.4423" transform="matrix(-0.756759 -0.653694 -0.756759 0.653694 10.365 9.24902)" />
                            </svg>
                        </div>
                        <div class="swiper-button-prev">
                            <svg width="12" height="18" viewBox="0 0 12 18"  xmlns="http://www.w3.org/2000/svg">
                                <rect width="1.13112" height="12.7853" transform="matrix(-0.756759 0.653694 -0.756759 -0.653694 11.2401 16.5938)"/>
                                <rect width="1.13112" height="12.4423" transform="matrix(0.756759 0.653694 0.756759 -0.653694 0.968262 8.75098)"/>
                            </svg>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            @foreach($wingedWords as $word)
                                <div class="blog-logo">
                                    ...
                                    <img src="{{ Voyager::image($word->word_image) }}" alt="">
                                </div>
                                <div class="blog-info">
                                    <h4>{{ $word->getTranslatedAttribute('name', \App::getLocale()) }}</h4>
                                    <p>
                ...
                <div class="grid blog-post-brands__grid">
                    @foreach($related as $item)
                        ...
                        <div class="item related-item">
                            <div class="image">
                                <img src="{{ Voyager::image($img[0] ?? '') }}" alt={{ $item->getTranslatedAttribute('title', \App::getLocale()) }}"">
                            </div>
